...
**Join as one of our first 20 restaurants and keep your founding subscription price for as long as your subscription remains active.**

Once the first 20 restaurants are filled, new restaurants will be charged the standard pricing.
...
* Technical maintenance
* Bug fixes
* Routine platform management
* Menu/content configuration
* Technical support
* Included platform features

The exact inclusions depend on the selected package.
...
* Additional annual-payment savings
* No large setup fee on managed plans
* Access to the selected managed platform
